...
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
   ...
   */
  @Override
  public EList<External> getExt()
  {
    if (ext == null)
    {
      ext = new EObjectContainmentEList<External>(External.class, this, MathPackage.PROGRAM__EXT);
    }
    return ext;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MathPackage.PROGRAM__EXT:
        getExt().clear();
        getExt().addAll((Collection<? extends External>)newValue);
        return;
      case MathPackage.PROGRAM__MATH:
